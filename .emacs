...
; Bright-red TODOs
 (setq fixme-modes '(c++-mode c-mode emacs-lisp-mode js2-mode js-mode))
...
(defun casey-big-fun-c-hook ()
  ...
  ;; I commented out Casey's headers for now.
  ...
  (add-to-list 'compilation-error-regexp-alist-alist '(casey-devenv
   ...
   2 3 nil (4)))
  (add-to-list 'compilation-error-regexp-alist 'cmake-shit)
  (add-to-list 'compilation-error-regexp-alist-alist '(cmake-shit
...
(define-key global-map [C-home] 'beginning-of-line)
...
(define-key global-map [C-M-right] 'clang-format-buffer)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(js2-mode graphql-mode eslint-fix clang-format dap-mode highlight-function-calls highlight-escape-sequences cpputils-cmake eglot lsp-ui lsp-mode auto-complete))
 '(version-control nil))
...
(set-face-attribute 'font-lock-comment-face nil :foreground "#a5a5a5") ;; FFFFFF
...
(set-face-attribute 'font-lock-regexp-grouping-construct nil :foreground "#c8cd7d")
